      ...
      <div className="flex flex-col justify-center md:flex-row h-screen">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8 relative">
          <div className="max-w-sm w-full">
            ...
            <h1 className="text-4xl text-center font-medium  overflow-hidden mb-12">Welcome Back !!</h1>
            ...
            <form onSubmit={handleLogin}>
              ...
              <div className="block md:hidden mt-5 font-semibold">
                <p>New to our platform? {""}
                  <Link to={"/register"} className="text-gray-500 hover:underline text-sm">Sign Up
                  </Link>
                </p>
              </div>


              <button type="submit" className="border-2 mt-5 border-zinc-700 w-full font-semibold bg-zinc-900 text-white py-2 rounded-lg hover:bg-white hover:text-zinc-700 transition">Sign In</button>
            </form>
          </div>
