    ...
    <>
      <div className="flex flex-col justify-center md:flex-row h-screen">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8 relative">
          <Link to={"/register"} className="border-2 border-zinc-600 rounded-3xl font-bold w-52 py-2 px-4 fixed top-10 -left-28 hover:bg-zinc-800 hover:text-white transition duration-300 text-end">Back</Link>
          ...
          <div className="max-w-sm w-full">
            ...
            <h1 className="text-4xl text-center font-medium  overflow-hidden mb-12">Check Your Mailbox</h1>
            ...
            <form onSubmit={handleOtpVerification}>
              ...
              <button type="submit" className="border-2 mt-5 border-zinc-700 w-full font-semibold bg-zinc-900 text-white py-2 rounded-lg hover:bg-white hover:text-zinc-700 transition">VERIFY</button>
            </form>
          </div>
