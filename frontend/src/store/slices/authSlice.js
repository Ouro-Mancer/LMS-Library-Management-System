...
export const otpVerification = (email, otp) => async (dispatch) => {
    ...
    await axios
        ...
        .then((res) => {
            dispatch(authSlice.actions.otpVerificationSuccess(res.data.message || "OTP verification successful"));
        }).catch((error) => {
...
export const login = (data) => async (dispatch) => {
    ...
    await axios
        ...
        .then((res) => {
            dispatch(authSlice.actions.loginSuccess(res.data.message || "Login successful"));
        }).catch((error) => {
...
export const logout = () => async (dispatch) => {
    ...
    await axios
        ...
        .then((res) => {
            dispatch(authSlice.actions.logoutSuccess(res.data.message || "Logout successful"));
            dispatch(authSlice.actions.resetAuthSlice());
        })
        .catch((error) => {
