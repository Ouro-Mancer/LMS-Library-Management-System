...
export const addBook = (data) => async (dispatch) => {
  ...
  await axios
    .post("http://localhost:4000/api/v1/book/add", data, {
...
// --- New Delete Book Async Function ---
export const deleteBook = (id) => async (dispatch) => {
  dispatch(bookSlice.actions.deleteBookRequest());
  await axios
    .delete(`http://localhost:4000/api/v1/book/delete/${id}`, { withCredentials: true })
    .then((res) => {
